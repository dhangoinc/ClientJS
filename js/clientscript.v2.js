...
const dhango = class {
    ...
    get address() {
        if (this.#paymentMethod != dhangoPaymentMethod.Card && !this.collectBillingAddress)
            return null;
    ...
    async displayTokenForm(elementId) {
        ...
        if (apiEnabledPaymentMethods.includes(dhangoPaymentMethod.AuDirectDebit)) {
            ...
            const paymentMethodFormContainer = this.createSelectablePaymentMethodFormContainer({
                ...
                radioIcon: 'radio-label-icon-audirectdebit',
    ...
    buildAuDirectDebitForm(formFieldsRowCssClass) {
        ...
        // Account Holder & BSB
        const formRow1 = document.createElement('div');
        formRow1.id = 'audirectdebit-form-row-1';
        formRow1.setAttribute('class', formFieldsRowCssClass);

        // Account Holder
        formRow1.appendChild(
            this.createFormElement('auDirectDebitAccountHolder', this.#localization.getTranslation('auDirectDebitAccountHolder'), {
                placeholder: this.#localization.getTranslation('auDirectDebitAccountHolder')
            })
        );
        ...
        const formRow2 = document.createElement('div');
        formRow2.id = 'audirectdebit-form-row-2';
        formRow2.setAttribute('class', formFieldsRowCssClass);
...
const localization = class {
    ...
    #translations = {
        "en": {
            ...
            "personal": "Personal",
            "corporate": "Corporate",
            "auDirectDebit": "Direct Debit",
            "auDirectDebitAccountHolder": "Bank Account Holder",
